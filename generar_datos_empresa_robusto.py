...
Versión que maneja límites de longitud de campos
"""
...
def determinar_tipo_edad(edad):
    """Determinar el tipo de edad basado en la edad (limitado a 10 caracteres)"""
    if edad < 1:
        return "Menor 1 año"
    elif edad < 5:
        return "1-4 años"
...
def generar_atenciones_empresa(cantidad=3000):
    ...
    for i in range(cantidad):
        ...
        # Generar período (últimos 2 años) - limitado a 10 caracteres
        ...
        atencion = {
            ...
            'sexo': sexo,
            'edad': edad,
            'tipo_edad': tipo_edad,  # Campo requerido, limitado a 10 caracteres
            'periodo': periodo,  # Limitado a 10 caracteres
...
def main():
    """Función principal"""
    print("Generador de Datos de Empresa - Version con Manejo de Errores")
    print("=" * 65)
